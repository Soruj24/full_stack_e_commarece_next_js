...
export function ProductCardImage({
  ...
  return (
    <div className="relative aspect-square overflow-hidden bg-muted/30">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none hidden sm:block" />
      ...
      <button
        ...
        className={cn(
          "absolute top-3 right-3 z-10 flex items-center justify-center w-10 h-10 rounded-full",
          ...
          "hover:bg-white dark:hover:bg-black/60 hover:shadow-md active:scale-90",
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 flex items-center justify-center gap-2 pb-3 pt-8 bg-gradient-to-t from-black/40 to-transparent sm:bg-none sm:bg-gradient-to-t sm:from-transparent sm:via-transparent sm:to-transparent sm:opacity-0 sm:translate-y-2 sm:group-hover:opacity-100 sm:group-hover:translate-y-0 transition-all duration-300 ease-out">
