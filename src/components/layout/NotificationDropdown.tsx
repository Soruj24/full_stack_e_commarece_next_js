  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          className="relative flex items-center justify-center w-9 h-9 rounded-lg text-muted-foreground hover:text-foreground hover:bg-accent/60 transition-all duration-150 focus-premium"
      ...
      <DropdownMenuContent
        align="end"
        className="w-[min(360px,calc(100vw-32px))] p-0 rounded-xl shadow-xl border-border/40 bg-popover/95 backdrop-blur-xl overflow-hidden mt-2"
      >
                ...
                <div className="flex gap-3">
                  <div
                    className={cn(
                      ...
                      !n.type && "bg-primary/10 text-primary",
                    )}
                  >
                    {n.type === "success" ? (
