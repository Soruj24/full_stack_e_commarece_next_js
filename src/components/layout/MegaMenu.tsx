...
import {
  ArrowRight, Star, TrendingUp, Sparkles, Zap,
      ...
      {isOpen && (
        <>
          <motion.div
            ...
            className="fixed inset-0 bg-black/20 mega-backdrop z-40"
            onClick={onClose}
            ...
            <div className="mx-4 mt-1 bg-white dark:bg-zinc-950 rounded-2xl shadow-2xl shadow-black/8 border border-black/[0.06] dark:border-white/[0.08] overflow-hidden">
              <div className="flex min-h-[380px]">
                ...
                <div className="w-[280px] border-r border-black/[0.06] dark:border-white/[0.08] py-4 px-2 overflow-y-auto max-h-[420px] shrink-0">
                  {topLevel.map((cat) => {
                    const isActiveCat = active?._id === cat._id;
                        ...
                        >
                          ...
                          <span
                            className={cn(
                              ...
                              isActiveCat
                                ? "text-foreground"
                                : "text-zinc-600 dark:text-zinc-400 group-hover:text-foreground",
                            )}
                          >
                            {cat.name}
                          </span>
                        ...
                        <div className="space-y-0.5">
                          {quickLinks.map((ql) => (
                            ...
                            >
                              ...
                              <span className="flex-1 text-[13px] font-medium text-zinc-700 dark:text-zinc-300 group-hover:text-foreground transition-colors">
                                {ql.name}
                              </span>
