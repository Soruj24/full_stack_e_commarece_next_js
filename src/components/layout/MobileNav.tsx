...
import { X, ChevronRight, ChevronDown, LogOut, LayoutDashboard, ShieldCheck } from "lucide-react";
            ...
            <div className="flex items-center justify-between px-4 h-14 border-b border-border/40 shrink-0">
              <Link href="/" onClick={close} className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-md bg-foreground flex items-center justify-center">
                  <ShieldCheck className="w-3.5 h-3.5 text-background" strokeWidth={2.5} />
                </div>
              ...
              {user ? (
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-0.5">
                    ...
                    <button
                      ...
                      className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-destructive/5 transition-colors"
                      aria-label="Sign out"
                    >
                ...
                <div className="flex gap-2">
                  <Button
                    asChild
                    variant="outline"
                    className="flex-1 h-10 rounded-lg text-[12px] font-medium"
                  >
