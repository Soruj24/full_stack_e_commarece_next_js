...
import { useRecentSearches } from "@/modules/search/hooks/use-recent-searches";
import { fetchSuggestionsAPI, performSearchAPI } from "@/modules/search/services/search-service";
import type { SearchResult, SearchFilters, SearchSuggestion, SearchContextType } from "@/modules/search/types/search-context";
import { defaultFilters } from "@/modules/search/types/search-context";
